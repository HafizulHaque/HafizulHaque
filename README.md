...
I am a professional **Full-Stack Web Developer** primarily focusing on **Frontend** with **4.5** years of industry experience. Currently I'm employed as a **Sr Frontend Engineer** at **Astha IT**, developing Bangladesh's first OTT platform **Toffee** at **Banglalink Digital Communications Ltd**. Prior to this role, I worked as a **Frontend Engineer** at **Reddot Digital Ltd**, a subsidery of reknowned TELCO company **Robi Axiata Ltd**.
...
- Backend REST API Development **(Node.js, Express.js, Nest.js, PostgreSQL, MongoDB)**
- E-Commerce **(Shopify)**
...
- any open-source web application frontend
